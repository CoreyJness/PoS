...
The frontend is implemented with Tkinter. I used Claude to assist with initial UI scaffolding, then adapted it to fit the needs of the deli.

Why This Project

This was intentionally designed as a real-world system, not a demo or coding exercise. The goal was to build something that:
